const projectSlides = [
...

    {
        ...
        bullets: [
            ...
            'Laurel contacted Sebastian to be involved with the project, we had to fix several items installed by the previous architect.',
            'I have been involved with the project from May 2009 until 2012 and from 2014 until present.',
...

{
    ...
    },
    {
        ...
        title: 'Demo for Pool Construction',
        caption: '2010 Here we are clearing the site to continue with the pool build.'
    },
    {
        images: [
            'img/site clearing.JPG',
            'img/site clearing2.JPG',
            'img/site clearing3.JPG', 
            'img/site clearing4.JPG'
        ],
